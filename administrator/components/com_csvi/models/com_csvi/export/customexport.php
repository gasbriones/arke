 ...
 * @version 	$Id: customexport.php 2273 2013-01-03 16:33:30Z RolandD $
 */
 ...
 * @subpackage 	Export
 */
class CsviModelCustomExport extends CsviModelExportfile {
	...
	public function getStart() {
		...
		$query->from($db->quoteName("#__".$template->get('custom_table')));
