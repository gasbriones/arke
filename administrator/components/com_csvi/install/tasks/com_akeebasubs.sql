...
('userimport', 'userimport', 'com_akeebasubs'),
('userimport', 'users', 'com_akeebasubs'),
('userimport', 'akeebasubs_users', 'com_akeebasubs');
...
('userimport', 'import', 'com_akeebasubs', 'index.php?option=com_akeebasubs&view=users', 'file,fields,limit');