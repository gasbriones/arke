...
('couponexport', 'awocoupon', 'com_awocoupon'),
('couponimport', 'couponimport', 'com_awocoupon'),
('couponimport', 'awocoupon', 'com_awocoupon'),
('giftcertificateexport', 'giftcertificateexport', 'com_awocoupon'),
('giftcertificateexport', 'awocoupon_giftcert_product', 'com_awocoupon'),
('giftcertificateimport', 'giftcertificateimport', 'com_awocoupon'),
('giftcertificateimport', 'awocoupon_giftcert_product', 'com_awocoupon'),
('giftcertificatecodeimport', 'giftcertificatecodeimport', 'com_awocoupon'),
('giftcertificatecodeimport', 'awocoupon_giftcert_code', 'com_awocoupon');
