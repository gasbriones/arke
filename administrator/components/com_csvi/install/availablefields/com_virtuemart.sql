...
('related_categories', 'related_categories', 'productimport', 'com_virtuemart'),
...
('custom_ordering', 'custom_ordering', 'productimport', 'com_virtuemart'),
('custom_multiple', 'custom_multiple', 'productimport', 'com_virtuemart'),
('custom_delete', 'custom_delete', 'productimport', 'com_virtuemart'),
...
('step_order_level', 'step_order_level', 'productimport', 'com_virtuemart'),
('product_tax_id', 'product_tax_id', 'productimport', 'com_virtuemart'),
('product_discount_id', 'product_discount_id', 'productimport', 'com_virtuemart'),
('product_ordering', 'product_ordering', 'productimport', 'com_virtuemart'),

/* VirtueMart Express Product import */
('skip', 'skip', 'expressproductimport', 'com_virtuemart'),
('combine', 'combine', 'expressproductimport', 'com_virtuemart'),
('product_name', 'product_name', 'expressproductimport', 'com_virtuemart'),
('product_s_desc', 'product_s_desc', 'expressproductimport', 'com_virtuemart'),
('product_desc', 'product_desc', 'expressproductimport', 'com_virtuemart'),
('metadesc', 'metadesc', 'expressproductimport', 'com_virtuemart'),
('metakey', 'metakey', 'expressproductimport', 'com_virtuemart'),
('customtitle', 'customtitle', 'expressproductimport', 'com_virtuemart'),
('slug', 'slug', 'expressproductimport', 'com_virtuemart'),
...
('mf_name_trans', 'mf_name_trans', 'manufacturerimport', 'com_virtuemart'),
...
('state', 'state', 'userinfoimport', 'com_virtuemart'),
('country', 'country', 'userinfoimport', 'com_virtuemart'),
('password_crypt', 'password_crypt', 'userinfoimport', 'com_virtuemart'),
...
('mf_name_trans', 'mf_name_trans', 'manufacturerexport', 'com_virtuemart'),
...
('file_url', 'file_url', 'manufacturerexport', 'com_virtuemart'),
('file_url_thumb', 'file_url_thumb', 'manufacturerexport', 'com_virtuemart'),

/* VirtueMart Medias export */
('product_sku', 'product_sku', 'mediaexport', 'com_virtuemart'),

/* Price import */
('skip', 'skip', 'priceimport', 'com_virtuemart'),
('combine', 'combine', 'priceimport', 'com_virtuemart'),
('price_delete', 'price_delete', 'priceimport', 'com_virtuemart'),
('product_name', 'product_name', 'priceexport', 'com_virtuemart'),
('product_sku', 'product_sku', 'priceimport', 'com_virtuemart'),
('shopper_group_name', 'shopper_group_name', 'priceimport', 'com_virtuemart'),
('shopper_group_name_new', 'shopper_group_name_new', 'priceimport', 'com_virtuemart'),
('product_price_new', 'product_price_new', 'priceimport', 'com_virtuemart'),

/* Price export */
('custom', 'custom', 'priceexport', 'com_virtuemart'),
('product_sku', 'product_sku', 'priceexport', 'com_virtuemart'),
('shopper_group_name', 'shopper_group_name', 'priceexport', 'com_virtuemart'),
...
('shipping_full_name', 'shipping_full_name', 'orderexport', 'com_virtuemart'),
...
('related_categories', 'related_categories', 'productexport', 'com_virtuemart'),
...
('picture_url_thumb', 'picture_url_thumb', 'productexport', 'com_virtuemart'),
...
('custom_ordering', 'custom_ordering', 'productexport', 'com_virtuemart'),
...
('file_title', 'file_title', 'productexport', 'com_virtuemart'),
('file_description', 'file_description', 'productexport', 'com_virtuemart'),
('file_meta', 'file_meta', 'productexport', 'com_virtuemart'),
('min_order_level', 'min_order_level', 'productexport', 'com_virtuemart'),
('max_order_level', 'max_order_level', 'productexport', 'com_virtuemart'),
('step_order_level', 'step_order_level', 'productexport', 'com_virtuemart'),
...
('product_discount', 'product_discount', 'productexport', 'com_virtuemart'),
('product_ordering', 'product_ordering', 'productexport', 'com_virtuemart'),
...
('shipment_name_trans', 'shipment_name_trans', 'shippingrateimport', 'com_virtuemart'),
...
('custom', 'custom', 'snelstartexport', 'com_virtuemart'),
('user_currency', 'user_currency', 'snelstartexport', 'com_virtuemart'), /* In the format EUR */
('payment_element', 'payment_element', 'snelstartexport', 'com_virtuemart'),
('state_name', 'state_name', 'snelstartexport', 'com_virtuemart'),
('state_2_code', 'state_2_code', 'snelstartexport', 'com_virtuemart'),
('state_3_code', 'state_3_code', 'snelstartexport', 'com_virtuemart'),
('virtuemart_state_id', 'virtuemart_state_id', 'snelstartexport', 'com_virtuemart'),
('country_name', 'country_name', 'snelstartexport', 'com_virtuemart'),
('country_2_code', 'country_2_code', 'snelstartexport', 'com_virtuemart'),
('country_3_code', 'country_3_code', 'snelstartexport', 'com_virtuemart'),
('virtuemart_country_id', 'virtuemart_country_id', 'snelstartexport', 'com_virtuemart'),
('shipment_element', 'shipment_element', 'snelstartexport', 'com_virtuemart'),
('order_status_name', 'order_status_name', 'snelstartexport', 'com_virtuemart'),
('full_name', 'full_name', 'snelstartexport', 'com_virtuemart'),
('username', 'username', 'snelstartexport', 'com_virtuemart'),
('total_order_items', 'total_order_items', 'snelstartexport', 'com_virtuemart'),
('discount_percentage', 'discount_percentage', 'snelstartexport', 'com_virtuemart'),
('product_price_total', 'product_price_total', 'snelstartexport', 'com_virtuemart'),
('invoice_number', 'invoice_number', 'snelstartexport', 'com_virtuemart'),
('shipment_name', 'shipment_name', 'snelstartexport', 'com_virtuemart'),
('payment_name', 'payment_name', 'snelstartexport', 'com_virtuemart'),
('shipping_company', 'shipping_company', 'snelstartexport', 'com_virtuemart'),
('shipping_title', 'shipping_title', 'snelstartexport', 'com_virtuemart'),
('shipping_last_name', 'shipping_last_name', 'snelstartexport', 'com_virtuemart'),
('shipping_first_name', 'shipping_first_name', 'snelstartexport', 'com_virtuemart'),
('shipping_middle_name', 'shipping_middle_name', 'snelstartexport', 'com_virtuemart'),
('shipping_full_name', 'shipping_full_name', 'snelstartexport', 'com_virtuemart'),
('shipping_phone_1', 'shipping_phone_1', 'snelstartexport', 'com_virtuemart'),
('shipping_phone_2', 'shipping_phone_2', 'snelstartexport', 'com_virtuemart'),
('shipping_fax', 'shipping_fax', 'snelstartexport', 'com_virtuemart'),
('shipping_address_1', 'shipping_address_1', 'snelstartexport', 'com_virtuemart'),
('shipping_address_2', 'shipping_address_2', 'snelstartexport', 'com_virtuemart'),
('shipping_city', 'shipping_city', 'snelstartexport', 'com_virtuemart'),
('shipping_state_name', 'shipping_state_name', 'snelstartexport', 'com_virtuemart'),
('shipping_state_2_code', 'shipping_state_2_code', 'snelstartexport', 'com_virtuemart'),
('shipping_state_3_code', 'shipping_state_3_code', 'snelstartexport', 'com_virtuemart'),
('shipping_country_name', 'shipping_country_name', 'snelstartexport', 'com_virtuemart'),
('shipping_country_2_code', 'shipping_country_2_code', 'snelstartexport', 'com_virtuemart'),
('shipping_country_3_code', 'shipping_country_3_code', 'snelstartexport', 'com_virtuemart'),
('shipping_zip', 'shipping_zip', 'snelstartexport', 'com_virtuemart'),
('shipping_email', 'shipping_email', 'snelstartexport', 'com_virtuemart'),
('product_subtotal_discount_percentage', 'product_subtotal_discount_percentage', 'snelstartexport', 'com_virtuemart');

/* Custom fields */
INSERT IGNORE INTO `#__csvi_available_fields` (csvi_name, component_name, component_table, component)
	(SELECT TRIM(custom_title), TRIM(custom_title), 'productimport', 'com_virtuemart'
		FROM `#__virtuemart_customs`
		WHERE field_type IN ('S', 'I', 'B', 'D', 'T', 'M')
	);

INSERT IGNORE INTO `#__csvi_available_fields` (csvi_name, component_name, component_table, component)
	(SELECT TRIM(custom_title), TRIM(custom_title), 'productexport', 'com_virtuemart'
		FROM `#__virtuemart_customs`
		WHERE field_type IN ('S', 'I', 'B', 'D', 'T', 'M')
	);