...
<fieldset>
	...
	<ul>
		...
		<li><div class="option_label"><?php echo $this->form->getLabel('estore', 'giftcertificate'); ?></div>
			<div class="option_value"><?php echo $this->form->getInput('estore', 'giftcertificate'); ?></div></li>
