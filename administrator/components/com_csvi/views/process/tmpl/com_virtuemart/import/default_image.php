 ...
 * @version 	$Id: default_image.php 2273 2013-01-03 16:33:30Z RolandD $
 */
...
<fieldset class="float31">
	...
	<ul>
		...
		<li><div class="option_label_image"><?php echo $this->form->getLabel('delete_product_images', 'image'); ?></div>
			<div class="option_value"><?php echo $this->form->getInput('delete_product_images', 'image'); ?></div></li>
