 ...
 * @version 	$Id: default_product.php 2301 2013-01-30 19:16:42Z RolandD $
 */
...
<fieldset>
	...
	<ul>
		...
		<li><div class="option_label"><?php echo $this->form->getLabel('recreate_alias', 'product'); ?></div>
			<div class="option_value"><?php echo $this->form->getInput('recreate_alias', 'product'); ?></div></li>
