...
?>
<form action="<?php echo JRoute::_('index.php?option=com_csvi'); ?>" method="post" id="adminForm" name="adminForm">
	...
	<table id="loglines" class="adminlist table table-condensed table-striped">
		...
		<div id="filterbox">
			...
			<input type="submit" class="btn" onclick="jQuery('#filter_action, #filter_result').val('');" value="<?php echo JText::_('COM_CSVI_LOGDETAILS_RESET'); ?>" />
