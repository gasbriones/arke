<?php
/**
 * Virtuemart categories media table
 *
 * @package 	CSVI
 ...
 * @version 	$Id: category_medias.php 2273 2013-01-03 16:33:30Z RolandD $
 */
 ...
 * @package CSVI
 */
class TableCategory_medias extends JTable {
	...
	public function check() {
		...
		$query->where('virtuemart_category_id = '.$db->Quote($this->virtuemart_category_id));
