...
$action = JRoute::_('index.php?option=com_k2store&view=weights');
		...
		<tr>
		   ...
		   <table class="adminlist table table-striped">
			<thead>
				...
				<th class="name">
					<?php echo JText::_('K2STORE_WEIGHT_TITLE_LABEL'); ?>
				</th>

				<th class="">
					<?php echo JText::_('K2STORE_WEIGHT_UNIT_LABEL'); ?>
				</th>
				<th class="">
					<?php echo JText::_('K2STORE_WEIGHT_VALUE_LABEL'); ?>
				</th>
				<th>
