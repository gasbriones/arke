...
<?php
$password ='<h2>'.JText::_('K2STORE_CHECKOUT_SET_PASSWORD').'</h2>';
$password .='<span class="required">*</span>'.JText::_('K2STORE_CHECKOUT_ENTER_PASSWORD');
$password .='<br /><input type="password" name="password" value="" class="large-field" /> <br /> <br />';
$confirm_password= '<span class="required">*</span>'.JText::_('K2STORE_CHECKOUT_CONFIRM_PASSWORD').'<br />
